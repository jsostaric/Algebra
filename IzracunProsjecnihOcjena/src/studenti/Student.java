...
public class Student {
	...
	public Student(String ustanova, int godina, ArrayList<String> listaKolegija, ArrayList<Integer> ocjeneKolegija,
			String ime, String prezime, int maticniBroj) {
	...
	public String toString() {
		return "Student{" + "godina=" + godina + 
				", listaKolegija=" + listaKolegija + ", ocjeneKolegija=" + 
				ocjeneKolegija + ", ime=" + ime + ", prezime=" + prezime + 
