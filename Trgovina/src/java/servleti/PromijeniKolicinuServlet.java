...
@WebServlet(name = "PromijeniKolicinuServlet", urlPatterns = {"/PromijeniKolicinuServlet"})
public class PromijeniKolicinuServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
          ...
          int kol = Integer.parseInt(request.getParameter("kol"));
